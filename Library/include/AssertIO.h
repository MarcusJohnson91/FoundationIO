...
#define static_assert _Static_assert
    ...
    void AssertIO_Message(const UTF8 *FileName, const UTF8 *FunctionName, UTF8 *AssertionString);

#if PlatformIO_BuildType == PlatformIO_BuildTypeIsDebug
#define AssertIO(Expression) ((void)((Expression)||(AssertIO_Message(PlatformIO_FileName, PlatformIO_FunctionName, #Expression),0)))
#else
