...
#if   ((PlatformIO_TargetOS & PlatformIO_TargetOSIsWindows) == PlatformIO_TargetOSIsWindows)
#include <BCrypt.h>
...
extern "C" {
    ...
    /* AES */
    static const uint8_t AESEncode[AESTableSize] = {
    ...
    static const uint8_t AESDecode[AESTableSize] = {
