...
extern "C" {
    ...
    UTF8 **UTF8_StringSet_Init(size_t NumStrings) {
        ...
        if (NumStrings > 0) {
            ...
            Log(Severity_DEBUG, PlatformIO_FunctionName, UTF8String("NumStrings %zu is invalid"), NumStrings);
        }
        return StringSet;
    }
    ...
    UTF32 *UTF32_StringSet_Flatten(ImmutableStringSet_UTF32 StringSet) {
        ...
        if (StringSet != NULL) {
            ...
            if (Flattened != NULL) {
                ...
                Log(Severity_DEBUG, PlatformIO_FunctionName, UTF8String("Couldn't allocate Flattened string of size: %zu"), FlattenedSize);
            }
        } else {
            Log(Severity_DEBUG, PlatformIO_FunctionName, UTF8String("StringSet Pointer is NULL"));
        }
