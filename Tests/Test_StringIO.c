...
extern "C" {
    ...
    void Test_UTF8_EncodeDecode(Entropy *Random) {
        if (Random != NULL) {
            ...
            if (StringsMatch == No) {
                Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("Strings DO NOT match!"));
            }
        } else {
    ...
    bool Test_UTF8_Properties(void) {
        ...
        if (TestStringSize != 7) {
            TestPassed           = false;
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("String \"%s\" is supposed to be 7 CodePoints long, but is actually %llu"), TestString8, TestStringSize);
        }
        return TestPassed;
    }
    ...
    bool Test_Deformat(void) {
        ...
        if (SubString1 == No || SubString2 == No || SubString3 == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("SubString doesn't match"));
        } else {
            TestPassed       = Yes;
        }
        return TestPassed;
    ...
    bool Test_UTF8_Format(void) {
        ...
        if (DoubleSpecifierTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("DoubleSpecifierTest Failed"));
        } else {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("DoubleSpecifierTest Passed"));
        }
        ...
        if (DuplicatePosition2Test1 == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("Rhyme Positional Test Failed"));
        } else {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("Rhyme Positional Test Passed"));
        }
        ...
        if (DuplicatePositionTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("OctalTest Failed"));
        } else {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("OctalTest Passed"));
        }
        ...
        if (Positional1Test == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("Positional1Test Failed"));
        } else {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("Positional1Test Passed"));
        }
        ...
        /*
         ...
         Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("Positional2Test Failed"));
         }
         */
        ...
        if (Positional3Test == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("Positional3Test Failed"));
        }
        ...
        if (PositionPrecisionTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("PositionPrecisionTest Failed"));
        }
        ...
        if (StringPrecisionTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("StringPreicisonTest Failed"));
        }
        
        UTF8 *Padding                          = UTF8_Format(UTF8String("%10.5i"), 9);
        bool  PaddingTest                      = UTF8_Compare(Padding, UTF8String("     00009"));
        if (PaddingTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("PaddingTest Failed"));
        }
        
        UTF8 *SpaceAlign                       = UTF8_Format(UTF8String("% d"), 4);
        bool SpaceAlignTest                    = UTF8_Compare(SpaceAlign, UTF8String(" 4"));
        if (SpaceAlignTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("SpaceAlignTest Failed"));
        }
        ...
        if (ZeroLeftAlignTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("ZeroLeftAlignTest Failed"));
        }
        
        UTF8 *Percent                          = UTF8_Format(UTF8String("%%"));
        bool PercentTest                       = UTF8_Compare(Percent, UTF8String("%"));
        if (PercentTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("PercentTest Failed"));
        }
        
        UTF8 *Smaller                          = UTF8_Format(UTF8String("%d"), 123);
        bool SmallerTest                       = UTF8_Compare(Smaller, UTF8String("123"));
        if (SmallerTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("SmallerTest Failed"));
        }
        
        UTF8 *Equal                            = UTF8_Format(UTF8String("%d"), 1094);
        bool EqualTest                         = UTF8_Compare(Equal, UTF8String("1094"));
        if (EqualTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("EqualTest Failed"));
        }
        ...
        if (LongerTest == No) {
            Log(Severity_DEBUG, FoundationIOFunctionName, UTF8String("LongerTest Failed"));
        }
        return TestPassed;
    }
